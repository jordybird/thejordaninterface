      ...
      <header className="fixed top-0 left-0 right-0 bg-white z-50 px-6 h-20 flex items-center">
        <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
          ...
          <nav className="hidden xl:flex items-center space-x-6 ml-12">
            <a href="#" className="text-sm font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Projects</a>
            <a href="#" className="text-sm font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Podcast</a>
            <a href="#" className="text-sm font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Newsletter</a>
           
            <a href="#" className="text-sm font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">Companies</a>
            <a href="#" className="text-sm font-semibold text-[#28282B] hover:text-[#28282B]/80 transition-colors">About</a>
          </nav>

          {/* Desktop CTA Buttons and Search */}
          <div className="hidden xl:flex items-center space-x-4 ml-auto">
            <button className="py-2.5 px-5 bg-[#8a2be2] text-white text-sm rounded-full hover:bg-[#7a1ed2] transition-colors font-semibold whitespace-nowrap">
              Do cool shit? Contact me.
            </button>
            <button className="py-2.5 px-5 bg-[#00bfff] text-white text-sm rounded-full hover:bg-[#0099cc] transition-colors font-semibold whitespace-nowrap">
              Become a Member
            </button>
            <button 
              onClick={() => setIsSearchOpen(true)}
              className="flex items-center text-[#28282B] hover:text-[#28282B]/80 transition-colors"
            >
          ...
          <button 
            ...
            className="xl:hidden text-[#28282B] hover:text-[#28282B]/80 transition-colors text-lg font-semibold focus:outline-none ml-auto"
          >
